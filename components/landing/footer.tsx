    ...
    <footer className="border-t border-border py-12 lg:py-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 lg:gap-12 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm">
              Smart email reminders that help you stay on top of what matters most.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Kokoro. All rights reserved.</p>
